        ...
        <div className="flex flex-col justify-content-center text-justify [text-align-last:center] font-semibold tracking-[2px] leading-7 lg:mt-0 mt-5 text-[13px] text-lightText">
          ...
          <div>
            <p className="primary-text description [word-spacing:2px] pb-5">
              ...
              design,” Falconer says. “I like to create unexpected combinations
              of finishes, fabrics, and custom-designed furnishings while
            ...
            <p className="primary-text description [word-spacing:2px] pb-5">
              ...
              awards, ASID Legacy of Design awards, ASID Design Ovation awards,
              Luxe RED Awards, Paper City Design Awards, and she has been named
              “Best Designer” by her peers in D Home magazine since 2005. Her
              work has been published in “Inspirations from France and Italy,”
              “The French Room”, both by Betty Lou Phillips, Luxe Magazine and D
              Home Magazine. Falconer has also been proud to serve as a Dallas
              Kip’s Bay Showhouse Vice Co-Chair.
            </p>
          </div>
        </div>
    </motion.div>
