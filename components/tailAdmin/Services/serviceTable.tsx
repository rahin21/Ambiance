        ...
        <tbody>
          {service.map((item) => (
            <tr key={item.id} className="bg-white border-b border-black/20">
              ...
              <td className="px-6 py-4">{item.subTitle.length>50?`${item.subTitle.slice(0,50)}...`:item.subTitle}</td>
              <td
                scope="row"
              ...
              <td className="px-6 py-4">{item.link.text.length>50?`${item.link.text.slice(0,50)}...`:item.link.text}</td>
              <td className="px-6 py-4">{item.link.plainUrl.length>50?`${item.link.plainUrl.slice(0,50)}...`:item.link.plainUrl}</td>
